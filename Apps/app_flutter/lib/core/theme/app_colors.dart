...
abstract final class AppColors {
  ...
  static const backgroundDark = Color(0xFF10111F);
  static const surfaceDark = Color(0xFF17182A);
  static const surfaceDimDark = Color(0xFF0D0E18);
  static const surfaceBrightDark = Color(0xFF20223A);
  static const surfaceContainerLowestDark = Color(0xFF0D0E18);
  static const surfaceContainerLowDark = Color(0xFF1C1D31);
  static const surfaceContainerDark = Color(0xFF23253D);
  static const surfaceContainerHighDark = Color(0xFF2C2E4A);
  static const surfaceContainerHighestDark = Color(0xFF353756);
  ...
  static Color get surfaceBright =>
      isDark ? surfaceBrightDark : surfaceBrightLight;
  static Color get surfaceContainerLowest =>
      isDark ? surfaceContainerLowestDark : surfaceContainerLowestLight;
  static Color get surfaceContainerLow =>
      isDark ? surfaceContainerLowDark : surfaceContainerLowLight;
  ...
  static Color get surfaceContainerHighest =>
      isDark ? surfaceContainerHighestDark : surfaceContainerHighestLight;
  ...
  static Color get inverseSurface =>
      isDark ? inverseSurfaceDark : inverseSurfaceLight;
  static Color get inverseOnSurface =>
      isDark ? inverseOnSurfaceDark : inverseOnSurfaceLight;

  static Color get outline => isDark ? outlineDark : outlineLight;
  static Color get outlineVariant =>
      isDark ? outlineVariantDark : outlineVariantLight;
  ...
  static Color get primaryContainer =>
      isDark ? primaryContainerDark : primaryContainerLight;
  static Color get onPrimaryContainer =>
      isDark ? onPrimaryContainerDark : onPrimaryContainerLight;
  static Color get primaryFixed =>
      isDark ? primaryFixedDark : primaryFixedLight;
  static Color get primaryFixedDim =>
      isDark ? primaryFixedDimDark : primaryFixedDimLight;
  static Color get onPrimaryFixed =>
      isDark ? onPrimaryFixedDark : onPrimaryFixedLight;
  ...
  static Color get secondaryContainer =>
      isDark ? secondaryContainerDark : secondaryContainerLight;
  static Color get onSecondaryContainer =>
      isDark ? onSecondaryContainerDark : onSecondaryContainerLight;
  static Color get secondaryFixed =>
      isDark ? secondaryFixedDark : secondaryFixedLight;
  static Color get secondaryFixedDim =>
      isDark ? secondaryFixedDimDark : secondaryFixedDimLight;
  ...
  static Color get tertiaryContainer =>
      isDark ? tertiaryContainerDark : tertiaryContainerLight;
  ...
  static Color get errorContainer =>
      isDark ? errorContainerDark : errorContainerLight;
  static Color get onErrorContainer =>
      isDark ? onErrorContainerDark : onErrorContainerLight;
  ...
  static Color get pageBg =>
      isDark ? const Color(0xFF0F1020) : const Color(0xFFF5F6FA);
  ...
  static List<Color> get pageGradient => isDark
      ? const [Color(0xFF111225), Color(0xFF17182A)]
  ...
  /// hero card/button.
  static Color softGlow(Color c) => c.withValues(alpha: isDark ? 0.34 : 0.26);
  ...
  static Color get cardShadow => isDark
      ? const Color(0x28000000)
      : const Color(0x044F3FBF); // Ultra-faint key shadow

  /// Soft, wide ambient shadow generating the smooth floating depth in Image #7
  static Color get cardShadowAmbient => isDark
      ? const Color(0x3D000000)
      : const Color(0x0A4F3FBF); // Ultra-diffuse ambient shadow
