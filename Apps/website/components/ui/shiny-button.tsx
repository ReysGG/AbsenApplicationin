...
import { LazyMotion, m, domAnimation, type MotionProps } from "motion/react"
...
>(({ children, className, ...props }, ref) => {
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <span
          className="relative block size-full text-sm tracking-wide text-current uppercase"
          style={{
            maskImage:
        ...
        <span
          style={{
            ...
            backgroundImage:
              "linear-gradient(-75deg,rgba(255,255,255,0.12) calc(var(--x)+20%),rgba(255,255,255,0.45) calc(var(--x)+25%),rgba(255,255,255,0.12) calc(var(--x)+100%))",
          }}
