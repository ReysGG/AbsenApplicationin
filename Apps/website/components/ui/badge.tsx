  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        archived:
          "border border-gray-300 bg-gray-100 text-gray-500 border-gray-200 italic line-through",
        // Work mode variants
        wfo: "border-transparent bg-blue-100 text-blue-800 border-blue-200",
        wfh: "border-transparent bg-purple-100 text-purple-800 border-purple-200",
        hybrid:
